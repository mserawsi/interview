  ...
  <div id="abox1975995395" class="header-hero mac-component-wrapper mac-abox-wrapper responsive-devicetype-desktop responsive-devicetype-mobile">
    <div class="aboxDefault">
      <div id="imgplaceholder1049447811" class="section imgplaceholder mac-component-wrapper mac-image-wrapper responsive-devicetype-desktop responsive-devicetype-not-mobile header-hero-image">
        <img class="" src="https://assets.pkimgs.com/pkimgs/ab/images/dp/ecm/202529/2559/001/002.jpg" alt="Lorem ipsum Hero">
      </div>
      <div id="imgplaceholder174020977" class="section imgplaceholder mac-component-wrapper mac-image-wrapper responsive-devicetype-not-desktop responsive-devicetype-mobile header-hero-image">
        <!---->
      </div>
...
defineProps({
  ...
  image: {
    type: String,
    default: 'https://assets.pkimgs.com/pkimgs/ab/images/dp/ecm/202529/2559/001/002.jpg'
  },
  imageAlt: {
    type: String,
    default: 'Hero image'
