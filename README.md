...
Pixel-perfect accuracy is not required for this exercise, but please get as close as you reasonably can. We value visual accuracy in production work.
...
- Match the layout, spacing, and overall visual style from the design reference by eye
